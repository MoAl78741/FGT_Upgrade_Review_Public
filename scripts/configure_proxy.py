...
config={'admin':{'listen':'0.0.0.0:2019'},'apps':{'pki':{'certificate_authorities':{'local':{'install_trust':False}}},'http':{'servers':{'site':{'listen':[':8443'],
 'automatic_https':{'disable_redirects':True},'tls_connection_policies':[{'default_sni':u.hostname}],
