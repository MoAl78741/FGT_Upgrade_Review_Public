...
export default function Installation() {
  ...
  if(caps?.edition==='public')return <p className="p-8 text-gray-400">Installation tools are available in the private edition.</p>;
  ...
  return <div className="max-w-3xl mx-auto p-6 space-y-6 text-gray-300">
    ...
    <p>Private edition · {caps?.version ? `Version ${caps.version}, build ${caps.build_number}`:'Checking build…'}</p>
