...
export default function Breadcrumbs() {
  ...
  const current = review ? 'Review details' : pathname.startsWith('/reports/') ? 'Source report' : pathname === '/reviews' ? 'Upgrade reviews' : pathname === '/library' ? 'Report library' : pathname === '/pro' ? 'Upgrade to Pro' : pathname === '/example' ? 'Example report' : pathname === '/account' ? 'Account & access' : pathname === '/administration' ? 'System administration' : pathname === '/installation' ? 'Setup & support' : 'Page';
