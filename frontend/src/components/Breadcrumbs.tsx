...
export default function Breadcrumbs() {
  ...
  const current = review ? 'Review details' : pathname.startsWith('/reports/') ? 'Source report' : pathname === '/reviews' ? 'Upgrade reviews' : pathname === '/account' ? 'Account & access' : pathname === '/administration' ? 'System administration' : pathname === '/installation' ? 'Setup & support' : 'Page';
