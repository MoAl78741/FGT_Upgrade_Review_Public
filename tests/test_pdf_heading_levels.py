...
def test_explicit_outline_levels_update_blocks_and_markdown(tmp_path):
    ...
    doc = pymupdf.open();doc.new_page();doc.set_toc([[1, 'Introduction', 1], [2, 'Supported models', 1], [3, 'Special branch supported models', 1]])
...
def test_ambiguous_or_unlisted_heading_keeps_its_existing_level(tmp_path):
    path = tmp_path / 'headings.pdf';doc = pymupdf.open();doc.new_page()
